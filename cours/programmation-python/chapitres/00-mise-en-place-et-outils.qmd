...
**Le terminal** exécute des commandes : `pwd`, `ls`, `cd`, `mkdir`.\\[2pt]
**Anaconda** installe Python ; `conda` crée des **environnements** isolés. On travaille toujours dans un environnement **activé**.\\[2pt]
**Jupyter** est le cahier : cellules de texte, de code, et sorties. Le numéro `In [n]` donne l'ordre réel d'exécution.\\[2pt]
**Un traceback se lit de bas en haut** : le type et le message d'abord, puis l'endroit.\\[2pt]
