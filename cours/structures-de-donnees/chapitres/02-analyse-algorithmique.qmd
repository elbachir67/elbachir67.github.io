...
::: {.figure-flottante}
{{< svg ../figures/s02-fig_02.svg alt="Au-delà de n_0 = 13, la courbe 5n^2 reste au-dessus de 3n^2 + 20n + 50. Le seuil est calculé, pas estimé : en n = 12 la majoration est fausse (722 > 720), en n = 13 elle devient vraie (817 845)." >}}
...
::: {.figure-flottante}
{{< svg ../figures/s02-fig_03.svg alt="Les classes usuelles. À n = 100 : _2 n 6,6, n_2 n 664, n^2 = 10 000. L'échelle logarithmique, à droite, rend les cinq familles lisibles simultanément." >}}
