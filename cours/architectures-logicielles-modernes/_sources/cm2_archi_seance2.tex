...
\end{ucaddef}
\centering\includegraphics[width=0.55\linewidth]{figC_inversion}
\end{frame}
...
\end{ucaddef}
\centering\includegraphics[width=0.50\linewidth]{figD_hexagone}
\end{frame}
...
\centering\includegraphics[width=0.64\linewidth]{figE_swap}
\end{frame}
...
\centering\includegraphics[width=0.80\linewidth]{figF_chemin_lab2}
