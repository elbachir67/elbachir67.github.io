...
\end{ucaddef}
\centering\includegraphics[width=0.58\linewidth]{f_supervised}
\vspace{-2pt}
...
\end{ucaddef}
\centering\includegraphics[width=0.82\linewidth]{f_traintest}
\vspace{-2pt}
...
\end{ucadfront}
\centering\includegraphics[width=0.27\linewidth]{f_boundary}
\vspace{-2pt}
...
\end{ucaddef}
\centering\includegraphics[width=0.38\linewidth]{f_impurity}
\vspace{-3pt}
...
\begin{frame}{Construire un arbre à la main — les données}
...
\centering\includegraphics[width=0.72\linewidth]{f_minitree}
\vspace{-2pt}
...
\end{ucadex}
\centering\includegraphics[width=0.48\linewidth]{f_infogain}
\vspace{-2pt}
...
\centering\includegraphics[width=0.80\linewidth]{f_tree}
\vspace{-2pt}
...
\centering\includegraphics[width=0.58\linewidth]{f_overfit}
\vspace{-2pt}
...
\centering\includegraphics[width=0.26\linewidth]{f_dartboard}
\vspace{-3pt}
...
\centering\includegraphics[width=0.99\linewidth]{f_threefits}
\vspace{-2pt}
...
\end{ucaddef}
\centering\includegraphics[width=0.50\linewidth]{f_importance}
\vspace{-2pt}
