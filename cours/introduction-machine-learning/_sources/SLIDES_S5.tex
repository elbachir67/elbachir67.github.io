...
% cadre de 700 unités (838 px mesurés). Rien n'est retiré.
\begin{frame}{Ce qui change depuis la Séance 3 : $y$ vit dans $\mathbb{R}$}
...
% Slide coupée en deux : l'analogie et la figure ne tenaient pas ensemble dans le cadre de 700
% unités (768 px mesurés). Rien n'est retiré.
\begin{frame}{Deux droites, et le résidu qui les départage}
...
\centering\includegraphics[width=\linewidth]{f5_coef_slope}
\end{columns}
\vspace{2pt}
...
\centering\includegraphics[width=0.78\linewidth]{f5_two_lines}
\vspace{-1pt}
...
\centering\includegraphics[width=\linewidth]{f5_bowl}
...
\centering\includegraphics[width=0.60\linewidth]{f5_eta}
\vspace{-2pt}
...
\centering\includegraphics[width=0.62\linewidth]{f5_mae_rmse}
\vspace{-2pt}
...
\begin{columns}[c]
\column{0.45\linewidth}
\centering\includegraphics[width=\linewidth]{f5_mae_vs_mse_opt}
\column{0.55\linewidth}
...
\centering\includegraphics[width=\linewidth]{f5_pred_vs_true}
\column{0.60\linewidth}
\centering\includegraphics[width=0.94\linewidth]{f5_residuals}
\end{columns}
\end{frame}

\begin{frame}{Ce que disent ces deux nuages}
...
\begin{frame}{La règle rigide et la tige souple, en image}
...
\centering\includegraphics[width=0.94\linewidth]{f5_threefits}
\vspace{-1pt}
...
\end{ucadex}
\column{0.50\linewidth}
\centering\includegraphics[width=\linewidth]{f5_ucurve}
\end{columns}
\vspace{1pt}
...
\centering\includegraphics[width=\linewidth,height=0.50\textheight,keepaspectratio]{f5_ridge}
\end{columns}
