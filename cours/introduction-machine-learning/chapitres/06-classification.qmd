...
ressources:
  ...
  - type: "td"
    titre: "Fiche d'exercices 6"
    fichier: "ressources/fiche-exos-s6.pdf"
    chemin: "/cours/introduction-machine-learning/ressources/fiche-exos-s6.pdf"
...
{{< svg ../figures/f6_sigmoid.svg alt="Figure intitulée « La sigmoïde : du score linéaire à la probabilité », « z égale b plus w scalaire x (le score linéaire) » en abscisse, « sigma de z (probabilité) » en ordonnée, libellés : « zone « plutôt 0 » », « zone « plutôt 1 » »." largeur="36%" >}}
...
:::
::: {.column width="52%"}
{{< svg ../figures/f6_logloss.svg alt="Figure intitulée « La log-loss : la confiance mal placée coûte très cher », « probabilité prédite p chapeau » en abscisse, « perte » en ordonnée, séries : « cas y égale 1 : perte égale moins le logarithme népérien de p chapeau », « cas y égale 0 : perte égale moins le logarithme népérien de 1 moins p chapeau »." >}}
:::
:::
...
{{< svg ../figures/f6_confusion.svg alt="Figure portant « jouet : … », « réalité : malade (y égale 1) », « réalité : sain (y égale 0) », « prédit : malade (y chapeau égale 1) », « prédit : sain (y chapeau égale 0) »." largeur="52%" >}}
...
![](../figures/f6_pr_matrix.png){.nostretch .figure-matricielle fig-alt="Matrice de confusion du jouet : vrais positifs 2, faux négatifs 1, faux positifs 1, vrais négatifs 2. Un cadre bleu entoure la colonne des alertes émises — precision = VP / (VP + FP) = 2/3 = 0,67 — et un cadre vert en tirets entoure la ligne des vrais malades — recall = VP / (VP + FN) = 2/3 = 0,67." width="64%"}
...
{{< svg ../figures/f6_roc_toy.svg alt="Figure intitulée « La ROC du jouet, construite point par point », « FPR (fausses alertes) » en abscisse, « TPR (recall) » en ordonnée, séries : « hasard (AUC 0,5) », libellés : « AUC égale 8 sur 9, environ 0,889 »." largeur="40%" >}}
