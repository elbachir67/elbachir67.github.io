...
# Prédire : le modèle linéaire]{Prédire une quantité : le modèle linéaire
...
# La meilleure droite]{La meilleure droite : la MSE
...
# L'équation normale]{L'équation normale : le minimum exact
...
# Mesurer : MAE, RMSE, R²]{Mesurer : MAE, RMSE, R² — et le verdict sur DataSANTÉ-221
...
# Le degré]{Le degré : sous- et sur-ajustement
...
# Ridge]{Ridge : dompter le sur-ajustement
