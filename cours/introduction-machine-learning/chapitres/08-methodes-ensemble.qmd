...
ressources:
  ...
  - type: "td"
    titre: "Fiche d'exercices 8"
    fichier: "ressources/fiche-exos-s8.pdf"
    chemin: "/cours/introduction-machine-learning/ressources/fiche-exos-s8.pdf"
...
{{< svg ../figures/f8_variance_moyenne.svg alt="Figure intitulée « Pourquoi décorréler : la variance d'une moyenne plafonne à la corrélation rho », « nombre d'arbres B moyennés » en abscisse, « variance de la moyenne (unité : variance d'un arbre) » en ordonnée, libellés : « plafond égale rho »." largeur="60%" >}}
