...
ressources:
  ...
  - type: "td"
    titre: "Fiche d'exercices 7"
    fichier: "ressources/fiche-exos-s7.pdf"
    chemin: "/cours/introduction-machine-learning/ressources/fiche-exos-s7.pdf"
...
{{< svg ../figures/f7_ridge_cv.svg alt="Figure intitulée « Le réglage de Ridge, version honnête : 5 plis sur les 30 points d'entraînement », « alpha (force de la pénalité Ridge) » en abscisse, « RMSE en validation croisée » en ordonnée, libellés : « meilleur : alpha égale 0,1 (RMSE CV 0,42) »." largeur="62%" >}}
...
{{< svg ../figures/f7_seuil_cv.svg alt="Figure intitulée « Le seuil réglé sur des probabilités de validation croisée », « seuil de décision » en abscisse, « métrique » en ordonnée, séries : « recall (probas CV) », « precision (probas CV) », libellés : « contrainte : rappel supérieur ou égal à 0,75 », « seuil retenu : 0,125 (sans toucher au test) »." largeur="66%" >}}
