...
{{< svg ../figures/f11_confusion.svg alt="À gauche, au seuil par défaut (0,5) : le modèle atteint 88,2 % d'accuracyen ne prédisant jamais « paludisme » (0 vrai positif, 235 malades manqués). Il a appris à dire « sain » à tout le monde — exactement la baseline. À droite, en abaissant le seuil à 0,20, le modèle repère enfin 67 malades (rappel 0,285), au prix de quelques fausses alertes." largeur="84%" >}}
