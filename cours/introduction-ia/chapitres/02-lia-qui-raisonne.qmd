...
::: {#fig-paysage}
{{< svg ../figures/s02-fig_01_ia_symbolique_paysage.svg alt="L'IA symbolique (logique, systèmes experts, calcul formel) dans le paysage global de l'Intelligence Artificielle. Cette séance se concentre sur la partie encadrée en pointillés. En Séance 4, les limites de la logique face à l'incertitude motiveront le passage aux probabilités." >}}

L'IA symbolique (logique, systèmes experts, calcul formel) dans le paysage global de l'Intelligence Artificielle. Cette séance se concentre sur la partie encadrée en pointillés. En Séance 4, les *limites* de la logique face à l'incertitude motiveront le passage aux probabilités.
:::
...
::: {.callout-warning .encadre-attentionbox title="Limites des systèmes experts -- motivation pour la Séance 4"}
