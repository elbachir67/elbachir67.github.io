...
**Prérequis :** Aucun prérequis spécifique en IA. Notions de programmation Python.<br>**Ouvre la voie vers :** Toutes les séances suivantes. Cette séance fournit le cadre conceptuel pour comprendre le raisonnement (S2), la recherche (S3), l'incertitude (S4) et l'apprentissage (S5).
:::
