...
ressources:
  ...
  - type: "td"
    titre: "TD — Exercices d'application"
    fichier: "ressources/td-exercices-organisation-memoire.pdf"
    chemin: "/cours/programmation-c-avancee/ressources/td-exercices-organisation-memoire.pdf"
  - type: "tp"
...
{{< svg ../figures/fig04_endianness.svg alt="Stockage de 0x01234567 à l'adresse 0x100. En big-endian (IBM, SPARC, réseau), l'octet de poids fort 01 est à l'adresse la plus basse ; en little-endian (Intel x86/x64, ARM), c'est l'octet de poids faible 67." >}}
...
{{< svg ../figures/fig08_array_2d.svg alt="Le tableau mat[2][3] vu en deux lignes, puis en mémoire, où la ligne 0 et la ligne 1 se suivent de 0x00 à 0x14. L'adresse d'une case vaut base + (i × nb_colonnes + j) × sizeof(int)." >}}
