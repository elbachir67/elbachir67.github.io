...
{{< svg ../figures/fig06_memory_evolution.svg alt="Évolution de la mémoire, étape par étape : x vaut 0x3CD02700, stocké en little-endian ; y = x + 3 ; z est déclaré sans valeur ; z = &y + 3 pointe 12 octets plus loin, en 0x24, où *z = y écrit la valeur de y." >}}
...
{{< svg ../figures/fig15_pointer_arithmetic.svg alt="Arithmétique des pointeurs selon le type : un int* avance de 4 octets, un short* de 2, un char* de 1. p + n ajoute n × sizeof(*p) octets à l'adresse." >}}
...
{{< svg ../figures/fig18_array_vs_string_pointer.svg alt="char arr[] = "Hello" est stocké sur la pile et modifiable. char *ptr = "Hello" est sur la pile, mais pointe vers le segment .rodata, en lecture seule." >}}
